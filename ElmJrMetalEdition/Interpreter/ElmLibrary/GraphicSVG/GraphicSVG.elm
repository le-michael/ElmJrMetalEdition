...
{-|
The GraphicSVG Library that will be used in ElmMetalJr. Some functions, such as the SVG implementation has been removed.
Whichever the parser does not currently support, the corresponding code blocks will be commented out as well.
}
...
{- LMD: PARSER UNIMPLEMENTED (record selectors in HiddenModel)
...
{-| LMD: Rework HTML Implementation
