...
let starterCode = """
    ...
    lights =
        [ DirectionalLight (RGB 0.6 0.6 0.6) (1.0, 2.0, 2.0) (RGB 0.1 0.1 0.1)
        , AmbientLight (RGB 1.0 1.0 1.0) 0.5
        ]

    scene = viewWithTimeAndCamera (ArcballCamera 5 (0.0, -1.0, 0.0) Nothing Nothing) (RGB 1.0 1.0 1.0) lights myShapes
"""
